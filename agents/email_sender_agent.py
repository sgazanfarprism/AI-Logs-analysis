...
class EmailSenderAgent:
    ...
    def send_alert(
        ...
        Args:
            ...
            csv_filepath: Optional path to CSV file to attach
        ...
        try:
            ...
            # Send email
            self._send_email(recipients, subject, html_body, csv_filepath)
    ...
    def _send_email(self, recipients: List[str], subject: str, html_body: str, csv_filepath: Optional[str] = None):
        ...
        try:
            ...
            if csv_filepath and Path(csv_filepath).exists():
                with open(csv_filepath, 'rb') as f:
                    ...
                    logger.info(f"Attached CSV file: {Path(csv_filepath).name}")
